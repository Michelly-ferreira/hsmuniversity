...
public class MichellyFerreiraAv01 {

	public static void main(String[] args) {
		
		Scanner sn = new Scanner(System.in);
		System.out.println("Sistema de Calculo de Média de Aprovação");
    ...
    System.out.println("Sua media no 1o Bimestre foi de "+mediaB1);
        ...
        if (mediaSemestral >= 8) {
			...
			System.out.print("Você não atingiu a média suficiente para a aprovação. Sua media semestral foi de "+mediaSemestral);
		}
	}
